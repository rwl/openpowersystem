...
# <<< imports
# @generated
from cpsm.load_model.non_conform_load import NonConformLoad
...
class InductionMotorLoad(NonConformLoad):
    """ Large three phase induction motor load. The typeName attribute indicates the type of induction motor (1 = wound rotor) (2 = squirrel cage). 
    """
    # <<< induction_motor_load.attributes
    # @generated
    # >>> induction_motor_load.attributes

    # <<< induction_motor_load.references
    # @generated
    # >>> induction_motor_load.references

    # <<< induction_motor_load.operations
    # @generated
    # >>> induction_motor_load.operations
