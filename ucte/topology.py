...
class TopologicalNode(IdentifiedObject):
    ...
    control_area = db.ReferenceProperty(db.Model, collection_name="topological_node")
    ...
    base_voltage = db.ReferenceProperty(db.Model, collection_name="topological_node")

    # The state voltage associated with the topological node.  
    sv_voltage = db.ReferenceProperty(collection_name="_topological_node_set")

    # A topological node belongs to a topological island 
    topological_island = db.ReferenceProperty(db.Model, collection_name="topological_nodes")

    # The island for which the node is an angle reference.   Normally there is one angle reference node for each island.  
    angle_ref_topological_island = db.ReferenceProperty(collection_name="_topological_node_set")
    ...
    connectivity_node_container = db.ReferenceProperty(db.Model, collection_name="topological_node")
...
class TopologicalIsland(IdentifiedObject):
    ...
    angle_ref_topological_node = db.ReferenceProperty(collection_name="_topological_island_set")
