...
class ReactiveCapabilityCurve(Curve):
    ...
    # The 'initially_used_by_synchronous_machine' property has been implicitly created by
...
class PowerTransformer(Equipment):
    ...
    # The 'contains_transformer_windings' property has been implicitly created by
    # the member_of_power_transformer' property of TransformerWinding.
    pass
